(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.PresentaBlockChartjs = factory(global.stream));
  ...
  var css_248z = ":root{--chartjsPadding:1rem}.style_chartjs__3DvIv{position:relative;padding:var(--chartjsPadding)}.style_chartjs__3DvIv,.style_cnv__1XZMd{width:100%;height:100%}";
  var css = {"chartjs":"style_chartjs__3DvIv","cnv":"style_cnv__1XZMd"};
  ...
  */
  ...
  const block = function (el, config) {
    ...
    const canvas = child.querySelector('canvas'); // I can set the whole chart.js config object

    if (def) createChart(); // or providing only the data as csv
    ...
    if (csv) {
      ...
      const labels = data.meta.fields.filter(d => d !== firstKey); // const colors = ['red', 'blue', 'orange']
  ...
  block.install = Presenta => {
    ...
    if (Presenta.io.addCache) Presenta.io.addCache({
      type: 'chartjs',
      field: 'url'
    });
  };
